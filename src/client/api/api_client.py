...
class ApiClient(object):
    """API client for API client library builds.

    API client. This client handles the client-
    server communication, and is invariant across implementations. Specifics of
    the methods and models for each application are generated from the API
    templates.
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'Alteryx/MCP/1.0.0'
