...
class LSqlExecutionJobCreateRequest(BaseJobCreateRequest):
    ...
    attribute_map = {
        'sql_script_id': 'sqlScriptId',
        'cp_job_id': 'cpJobId'
    }
    if hasattr(BaseJobCreateRequest, "attribute_map"):
        attribute_map.update(BaseJobCreateRequest.attribute_map)

    def __init__(self, sql_script_id=None, cp_job_id=None, *args, **kwargs):  # noqa: E501
        """SqlExecutionJobCreateRequest - a model defined in Swagger"""  # noqa: E501
        self._sql_script_id = None
    ...
    @property
    def sql_script_id(self):
        """Gets the sql_script_id of this SqlExecutionJobCreateRequest.  # noqa: E501


        :return: The sql_script_id of this SqlExecutionJobCreateRequest.  # noqa: E501
        :rtype: object
        """
        return self._sql_script_id

    @sql_script_id.setter
    def sql_script_id(self, sql_script_id):
        """Sets the sql_script_id of this SqlExecutionJobCreateRequest.


        :param sql_script_id: The sql_script_id of this SqlExecutionJobCreateRequest.  # noqa: E501
        :type: object
        """
        if sql_script_id is None:
            raise ValueError("Invalid value for `sql_script_id`, must not be `None`")  # noqa: E501

        self._sql_script_id = sql_script_id

    @property
    def cp_job_id(self):
        """Gets the cp_job_id of this SqlExecutionJobCreateRequest.  # noqa: E501


        :return: The cp_job_id of this SqlExecutionJobCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cp_job_id(self, cp_job_id):
        """Sets the cp_job_id of this SqlExecutionJobCreateRequest.


        :param cp_job_id: The cp_job_id of this SqlExecutionJobCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SqlExecutionJobCreateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SqlExecutionJobCreateRequest):
            return False
