...
class LBillingAccountData(object):
    ...
    def billing_account_name(self, billing_account_name):
        ...
        if billing_account_name is None:
            raise ValueError("Invalid value for `billing_account_name`, must not be `None`")  # noqa: E501
    ...
    def workspace_ids(self, workspace_ids):
        ...
        if workspace_ids is None:
            raise ValueError("Invalid value for `workspace_ids`, must not be `None`")  # noqa: E501
