...
class LRunParameterTrifactaPattern(object):
    ...
    """
    swagger_types = {
        'trifacta_pattern': 'object'
    }

    attribute_map = {
        'trifacta_pattern': 'trifactaPattern'
    }
    ...
    def trifacta_pattern(self, trifacta_pattern):
        ...
        if trifacta_pattern is None:
            raise ValueError("Invalid value for `trifacta_pattern`, must not be `None`")  # noqa: E501

        self._trifacta_pattern = trifacta_pattern
