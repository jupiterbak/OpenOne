...
class LWrangleJobCreateRequest(BaseJobCreateRequest):
    ...
    attribute_map = {
        ...
        'emr_spark_info': 'emrSparkInfo'
    }
    if hasattr(BaseJobCreateRequest, "attribute_map"):
        attribute_map.update(BaseJobCreateRequest.attribute_map)

    def __init__(self, cp_job_id=None, execution_language=None, emr_spark_info=None, *args, **kwargs):  # noqa: E501
        """WrangleJobCreateRequest - a model defined in Swagger"""  # noqa: E501
        ...
        if emr_spark_info is not None:
            self.emr_spark_info = emr_spark_info
        BaseJobCreateRequest.__init__(self, *args, **kwargs)

    @property
    def cp_job_id(self):
        """Gets the cp_job_id of this WrangleJobCreateRequest.  # noqa: E501


        :return: The cp_job_id of this WrangleJobCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cp_job_id(self, cp_job_id):
        """Sets the cp_job_id of this WrangleJobCreateRequest.


        :param cp_job_id: The cp_job_id of this WrangleJobCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def execution_language(self):
        """Gets the execution_language of this WrangleJobCreateRequest.  # noqa: E501
        ...
        :return: The execution_language of this WrangleJobCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def execution_language(self, execution_language):
        """Sets the execution_language of this WrangleJobCreateRequest.

        Execution language. Indicate on which engine the job was executed.   Can be null/missing for scheduled jobs that fail during the validation phase.  * `photon` - Photon engine. High performance embedded engine designed for small datasets (up to 1GB).       Not available for all product editions. * `amp` - Amp engine. * `xml-amp` - XML-AMP engine. Only available for standard workflows.    * `emrSpark` - Spark engine running on EMR       # noqa: E501

        :param execution_language: The execution_language of this WrangleJobCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def emr_spark_info(self):
        """Gets the emr_spark_info of this WrangleJobCreateRequest.  # noqa: E501


        :return: The emr_spark_info of this WrangleJobCreateRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def emr_spark_info(self, emr_spark_info):
        """Sets the emr_spark_info of this WrangleJobCreateRequest.


        :param emr_spark_info: The emr_spark_info of this WrangleJobCreateRequest.  # noqa: E501
        :type: object
        """

        self._emr_spark_info = emr_spark_info
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WrangleJobCreateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WrangleJobCreateRequest):
            return False
