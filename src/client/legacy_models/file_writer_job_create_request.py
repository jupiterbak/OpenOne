...
class LFileWriterJobCreateRequest(BaseJobCreateRequest):
    ...
    attribute_map = {
        'writesetting_id': 'writesettingId',
    ...
    def __init__(self, writesetting_id=None, scriptresult_id=None, *args, **kwargs):  # noqa: E501
        """FileWriterJobCreateRequest - a model defined in Swagger"""  # noqa: E501
        self._writesetting_id = None
        self._scriptresult_id = None
        self.discriminator = None
        self.writesetting_id = writesetting_id
        self.scriptresult_id = scriptresult_id
        BaseJobCreateRequest.__init__(self, *args, **kwargs)

    @property
    def writesetting_id(self):
        """Gets the writesetting_id of this FileWriterJobCreateRequest.  # noqa: E501


        :return: The writesetting_id of this FileWriterJobCreateRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def writesetting_id(self, writesetting_id):
        """Sets the writesetting_id of this FileWriterJobCreateRequest.


        :param writesetting_id: The writesetting_id of this FileWriterJobCreateRequest.  # noqa: E501
        :type: int
        """
        if writesetting_id is None:
            raise ValueError("Invalid value for `writesetting_id`, must not be `None`")  # noqa: E501

        self._writesetting_id = writesetting_id

    @property
    def scriptresult_id(self):
        """Gets the scriptresult_id of this FileWriterJobCreateRequest.  # noqa: E501


        :return: The scriptresult_id of this FileWriterJobCreateRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def scriptresult_id(self, scriptresult_id):
        """Sets the scriptresult_id of this FileWriterJobCreateRequest.


        :param scriptresult_id: The scriptresult_id of this FileWriterJobCreateRequest.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FileWriterJobCreateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileWriterJobCreateRequest):
            return False
