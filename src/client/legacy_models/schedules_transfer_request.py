...
class LSchedulesTransferRequest(object):
    ...
    def __init__(self, schedule_ids=None, to_user_id=None, to_workspace_id=None):  # noqa: E501
        ...
        if to_workspace_id is not None:
            self.to_workspace_id = to_workspace_id
    ...
    def schedule_ids(self, schedule_ids):
        ...
        if schedule_ids is None:
            raise ValueError("Invalid value for `schedule_ids`, must not be `None`")  # noqa: E501
    ...
    def to_workspace_id(self, to_workspace_id):
        ...
        self._to_workspace_id = to_workspace_id
