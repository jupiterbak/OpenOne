...
class LAnyOfoutputNodeEdgesOutFlowNodeId(object):
    ...
    def __init__(self):  # noqa: E501
        """AnyOfoutputNodeEdgesOutFlowNodeId - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AnyOfoutputNodeEdgesOutFlowNodeId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnyOfoutputNodeEdgesOutFlowNodeId):
            return False
