...
class LDeleteSettingsResponse(object):
    ...
    """
    swagger_types = {
        'number_of_rows_deleted': 'int'
    }

    attribute_map = {
        'number_of_rows_deleted': 'numberOfRowsDeleted'
    }
    ...
    def number_of_rows_deleted(self, number_of_rows_deleted):
        ...
        if number_of_rows_deleted is None:
            raise ValueError("Invalid value for `number_of_rows_deleted`, must not be `None`")  # noqa: E501

        self._number_of_rows_deleted = number_of_rows_deleted
