...
class LKeySecret(object):
    ...
    def __init__(self, key=None, secret=None, server_side_encryption=None, server_side_kms_key_id=None):  # noqa: E501
        ...
        self._server_side_kms_key_id = None
        ...
        if server_side_kms_key_id is not None:
            self.server_side_kms_key_id = server_side_kms_key_id
    ...
    def server_side_encryption(self, server_side_encryption):
        ...
        if server_side_encryption not in allowed_values:
            raise ValueError(
                "Invalid value for `server_side_encryption` ({0}), must be one of {1}"  # noqa: E501
                .format(server_side_encryption, allowed_values)
            )
