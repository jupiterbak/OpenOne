...
class LAccountUser(object):
    ...
    attribute_map = {
        ...
        'status': 'status',
        'roles': 'roles',
        'maximal_capabilities': 'maximalCapabilities'
    }
    ...
    def __init__(self, billing_account_id=None, name=None, sfdc_account_id=None, workspaces=None, status=None, roles=None, maximal_capabilities=None):  # noqa: E501
        ...
        self._status = None
        self._roles = None
        self._maximal_capabilities = None
        ...
        self.status = status
        self.roles = roles
        if maximal_capabilities is not None:
            self.maximal_capabilities = maximal_capabilities
    ...
    def sfdc_account_id(self, sfdc_account_id):
        ...
        if sfdc_account_id is None:
            raise ValueError("Invalid value for `sfdc_account_id`, must not be `None`")  # noqa: E501

        self._sfdc_account_id = sfdc_account_id
    ...
    def status(self, status):
        ...
        allowed_values = ["enabled", "disabled", "invited"]  # noqa: E501
