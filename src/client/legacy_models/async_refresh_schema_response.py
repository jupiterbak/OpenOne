...
class LAsyncRefreshSchemaResponse(object):
    ...
    """
    swagger_types = {
        'resource_task_state_id': 'int'
    }

    attribute_map = {
        'resource_task_state_id': 'resourceTaskStateId'
    }
    ...
    def resource_task_state_id(self, resource_task_state_id):
        ...
        if resource_task_state_id is None:
            raise ValueError("Invalid value for `resource_task_state_id`, must not be `None`")  # noqa: E501

        self._resource_task_state_id = resource_task_state_id
