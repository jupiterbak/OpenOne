...
class LSshTunnelingSshKey(object):
    ...
    swagger_types = {
        ...
        'ssh_tunneling_ssh_key': 'str'
    }

    attribute_map = {
        'ssh_tunneling_username': 'sshTunnelingUsername',
        'ssh_tunneling_ssh_key': 'sshTunnelingSshKey'
    }
    ...
    def __init__(self, ssh_tunneling_username=None, ssh_tunneling_ssh_key=None):  # noqa: E501
        ...
        self.ssh_tunneling_ssh_key = ssh_tunneling_ssh_key
    ...
    def ssh_tunneling_ssh_key(self, ssh_tunneling_ssh_key):
        ...
        if ssh_tunneling_ssh_key is None:
            raise ValueError("Invalid value for `ssh_tunneling_ssh_key`, must not be `None`")  # noqa: E501

        self._ssh_tunneling_ssh_key = ssh_tunneling_ssh_key
