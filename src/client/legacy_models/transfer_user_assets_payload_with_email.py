...
class LTransferUserAssetsPayloadWithEmail(object):
    ...
    """
    swagger_types = {
        'from_person_email': 'str',
        'to_person_email': 'str',
        'assets': 'object'
    }

    attribute_map = {
        'from_person_email': 'fromPersonEmail',
    ...
    def __init__(self, from_person_email=None, to_person_email=None, assets=None):  # noqa: E501
        ...
        self.from_person_email = from_person_email
        self.to_person_email = to_person_email
    ...
    def from_person_email(self, from_person_email):
        ...
        if from_person_email is None:
            raise ValueError("Invalid value for `from_person_email`, must not be `None`")  # noqa: E501

        self._from_person_email = from_person_email
    ...
    def to_person_email(self, to_person_email):
        ...
        if to_person_email is None:
            raise ValueError("Invalid value for `to_person_email`, must not be `None`")  # noqa: E501

        self._to_person_email = to_person_email
