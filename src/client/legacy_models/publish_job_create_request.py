...
class LPublishJobCreateRequest(BaseJobCreateRequest):
    ...
    attribute_map = {
        ...
        'scriptresult_id': 'scriptresultId'
    }
    if hasattr(BaseJobCreateRequest, "attribute_map"):
        attribute_map.update(BaseJobCreateRequest.attribute_map)

    def __init__(self, adhoc=None, publication_id=None, scriptresult_id=None, *args, **kwargs):  # noqa: E501
        """PublishJobCreateRequest - a model defined in Swagger"""  # noqa: E501
        self._adhoc = None
        ...
        self.scriptresult_id = scriptresult_id
        BaseJobCreateRequest.__init__(self, *args, **kwargs)

    @property
    def adhoc(self):
        """Gets the adhoc of this PublishJobCreateRequest.  # noqa: E501


        :return: The adhoc of this PublishJobCreateRequest.  # noqa: E501
        :rtype: bool
        """
        return self._adhoc
    ...
    def adhoc(self, adhoc):
        """Sets the adhoc of this PublishJobCreateRequest.


        :param adhoc: The adhoc of this PublishJobCreateRequest.  # noqa: E501
        :type: bool
        """
    ...
    def publication_id(self):
        """Gets the publication_id of this PublishJobCreateRequest.  # noqa: E501


        :return: The publication_id of this PublishJobCreateRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def publication_id(self, publication_id):
        """Sets the publication_id of this PublishJobCreateRequest.


        :param publication_id: The publication_id of this PublishJobCreateRequest.  # noqa: E501
        :type: object
        """
    ...
    def scriptresult_id(self):
        """Gets the scriptresult_id of this PublishJobCreateRequest.  # noqa: E501


        :return: The scriptresult_id of this PublishJobCreateRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def scriptresult_id(self, scriptresult_id):
        """Sets the scriptresult_id of this PublishJobCreateRequest.


        :param scriptresult_id: The scriptresult_id of this PublishJobCreateRequest.  # noqa: E501
        :type: object
        """
        if scriptresult_id is None:
            raise ValueError("Invalid value for `scriptresult_id`, must not be `None`")  # noqa: E501

        self._scriptresult_id = scriptresult_id
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PublishJobCreateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PublishJobCreateRequest):
            return False
