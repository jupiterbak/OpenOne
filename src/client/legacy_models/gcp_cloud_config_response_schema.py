...
class LGcpCloudConfigResponseSchema(object):
    ...
    attribute_map = {
        ...
        'service_account_key_configured': 'serviceAccountKeyConfigured'
    }
    ...
    def __init__(self, enabled=None, settings=None, default_bucket=None, default_project=None, service_account_key_configured=None):  # noqa: E501
        ...
        self._service_account_key_configured = None
        ...
        if service_account_key_configured is not None:
            self.service_account_key_configured = service_account_key_configured
    ...
    def service_account_key_configured(self, service_account_key_configured):
        ...
        self._service_account_key_configured = service_account_key_configured
