...
class LBucketHistogram(object):
    ...
    def round_min(self, round_min):
        ...
        if round_min is None:
            raise ValueError("Invalid value for `round_min`, must not be `None`")  # noqa: E501

        self._round_min = round_min
    ...
    def round_max(self, round_max):
        ...
        if round_max is None:
            raise ValueError("Invalid value for `round_max`, must not be `None`")  # noqa: E501
    ...
    def quartiles(self, quartiles):
        ...
        if quartiles is None:
            raise ValueError("Invalid value for `quartiles`, must not be `None`")  # noqa: E501
