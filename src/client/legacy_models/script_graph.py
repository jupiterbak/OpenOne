...
class LScriptGraph(object):
    ...
    attribute_map = {
        'node_ids': 'nodeIds',
        'node_to_lines': 'nodeToLines',
        'node_load_limit': 'nodeLoadLimit',
        'node_info': 'nodeInfo'
    }
    ...
    def __init__(self, node_ids=None, node_to_lines=None, node_load_limit=None, node_info=None):  # noqa: E501
        ...
        self.node_load_limit = node_load_limit
    ...
    def node_to_lines(self, node_to_lines):
        ...
        self._node_to_lines = node_to_lines
    ...
    def node_load_limit(self, node_load_limit):
        ...
        if node_load_limit is None:
            raise ValueError("Invalid value for `node_load_limit`, must not be `None`")  # noqa: E501

        self._node_load_limit = node_load_limit
