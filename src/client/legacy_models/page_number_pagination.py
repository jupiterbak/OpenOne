...
class LPageNumberPagination(object):
    ...
    def __init__(self, pagination_type=None, pagenumberparam=None, pagesizeparam=None, pagesize=None):  # noqa: E501
        ...
        self.pagenumberparam = pagenumberparam
    ...
    def pagenumberparam(self, pagenumberparam):
        ...
        if pagenumberparam is None:
            raise ValueError("Invalid value for `pagenumberparam`, must not be `None`")  # noqa: E501

        self._pagenumberparam = pagenumberparam
