...
class LInviteUserPayload(object):
    ...
    swagger_types = {
        'email': 'str',
        'skip_email_invitations': 'list[str]'
    }

    attribute_map = {
        'email': 'email',
        'skip_email_invitations': 'skipEmailInvitations'
    }
    ...
    def __init__(self, email=None, skip_email_invitations=None):  # noqa: E501
        ...
        self.email = email
        if skip_email_invitations is not None:
            self.skip_email_invitations = skip_email_invitations
    ...
    def skip_email_invitations(self, skip_email_invitations):
        ...
        self._skip_email_invitations = skip_email_invitations
