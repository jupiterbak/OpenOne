...
class LFlowNodeUpdateRequest(object):
    ...
    swagger_types = {
        'activesample_id': 'int',
        'reference_id': 'int',
        'sample_load_limit': 'int',
        'deleted_at': 'datetime'
    }

    attribute_map = {
        'activesample_id': 'activesampleId',
        'reference_id': 'referenceId',
        'sample_load_limit': 'sampleLoadLimit',
    ...
    def __init__(self, activesample_id=None, reference_id=None, sample_load_limit=None, deleted_at=None):  # noqa: E501
        ...
        if activesample_id is not None:
            self.activesample_id = activesample_id
        if reference_id is not None:
            self.reference_id = reference_id
        if sample_load_limit is not None:
            self.sample_load_limit = sample_load_limit
    ...
    def activesample_id(self, activesample_id):
        ...
        self._activesample_id = activesample_id
    ...
    def sample_load_limit(self, sample_load_limit):
        ...
        self._sample_load_limit = sample_load_limit
