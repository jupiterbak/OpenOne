...
class LGcpAccount(object):
    ...
    def __init__(self, project_id=None, secret_key=None, region=None, vpc_name=None, control_plane_addr_range=None):  # noqa: E501
        ...
        self._region = None
        self._vpc_name = None
        self._control_plane_addr_range = None
        ...
        self.control_plane_addr_range = control_plane_addr_range
    ...
    def control_plane_addr_range(self, control_plane_addr_range):
        ...
        if control_plane_addr_range is None:
            raise ValueError("Invalid value for `control_plane_addr_range`, must not be `None`")  # noqa: E501

        self._control_plane_addr_range = control_plane_addr_range
