...
class LPublishMetadataInfo(object):
    ...
    attribute_map = {
        ...
        'publish_type_map': 'publishTypeMap',
        'publish_validation': 'publishValidation',
        'publish_queries': 'publishQueries',
    ...
    def __init__(self, publish_method=None, publish_type_map=None, publish_validation=None, publish_queries=None, performance_params=None, publish_info=None):  # noqa: E501
        ...
        self._publish_queries = None
        self._performance_params = None
        self._publish_info = None
        self.discriminator = None
        if publish_method is not None:
            self.publish_method = publish_method
        if publish_type_map is not None:
            self.publish_type_map = publish_type_map
        if publish_validation is not None:
            self.publish_validation = publish_validation
        if publish_queries is not None:
            self.publish_queries = publish_queries
    ...
    def publish_method(self, publish_method):
        ...
        if publish_method not in allowed_values:
            raise ValueError(
                "Invalid value for `publish_method` ({0}), must be one of {1}"  # noqa: E501
                .format(publish_method, allowed_values)
            )
    ...
    def publish_type_map(self, publish_type_map):
        ...
        self._publish_type_map = publish_type_map
    ...
    def publish_validation(self, publish_validation):
        ...
        self._publish_validation = publish_validation
    ...
    def publish_queries(self, publish_queries):
        ...
        self._publish_queries = publish_queries
