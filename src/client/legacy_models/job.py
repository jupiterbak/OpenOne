...
class LJob(object):
    ...
    discriminator_value_class_map = {
            'wrangle'.lower(): '#/components/schemas/wrangleJobResponse',
            'ingest'.lower(): '#/components/schemas/ingestJobResponse',
            'profile'.lower(): '#/components/schemas/profileJobResponse',
            'publish'.lower(): '#/components/schemas/publishJobResponse',
            'filewriter'.lower(): '#/components/schemas/fileWriterJobResponse',
            'filereader'.lower(): '#/components/schemas/filereaderJobResponse',
            'fileconverter'.lower(): '#/components/schemas/fileConverterJobResponse',
