...
class LPagingTokenPagination(object):
    ...
    attribute_map = {
        ...
        'pagetokenpath': 'pagetokenpath',
        'hasmorepath': 'hasmorepath',
        'pagetokenparam': 'pagetokenparam'
    }
    ...
    def __init__(self, pagination_type=None, pagetokenpath=None, hasmorepath=None, pagetokenparam=None):  # noqa: E501
        ...
        self._pagetokenparam = None
        self.discriminator = None
        self.pagination_type = pagination_type
        self.pagetokenpath = pagetokenpath
        if hasmorepath is not None:
            self.hasmorepath = hasmorepath
        self.pagetokenparam = pagetokenparam
    ...
    def pagination_type(self, pagination_type):
        ...
        if pagination_type is None:
            raise ValueError("Invalid value for `pagination_type`, must not be `None`")  # noqa: E501
    ...
    def pagetokenpath(self, pagetokenpath):
        ...
        if pagetokenpath is None:
            raise ValueError("Invalid value for `pagetokenpath`, must not be `None`")  # noqa: E501

        self._pagetokenpath = pagetokenpath
    ...
    def pagetokenparam(self, pagetokenparam):
        ...
        if pagetokenparam is None:
            raise ValueError("Invalid value for `pagetokenparam`, must not be `None`")  # noqa: E501

        self._pagetokenparam = pagetokenparam
