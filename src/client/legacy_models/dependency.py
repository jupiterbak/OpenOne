...
class LDependency(object):
    ...
    swagger_types = {
        ...
        'created_at': 'datetime',
        'updated_at': 'datetime',
        'approved_dependency': 'object',
        'script_lines': 'object',
        'editable_scripts': 'object',
        'flow': 'object'
    }
    ...
    attribute_map = {
        ...
        'approved_dependency': 'approvedDependency',
        'script_lines': 'scriptLines',
        'editable_scripts': 'editableScripts',
        'flow': 'flow'
    }
    ...
    def __init__(self, id=None, name=None, description=None, creator=None, updater=None, created_at=None, updated_at=None, approved_dependency=None, script_lines=None, editable_scripts=None, flow=None):  # noqa: E501
        ...
        if approved_dependency is not None:
            self.approved_dependency = approved_dependency
        if script_lines is not None:
            self.script_lines = script_lines
        if editable_scripts is not None:
            self.editable_scripts = editable_scripts
        if flow is not None:
            self.flow = flow
    ...
    def approved_dependency(self, approved_dependency):
        ...
        self._approved_dependency = approved_dependency
    ...
    def editable_scripts(self, editable_scripts):
        ...
        self._editable_scripts = editable_scripts
