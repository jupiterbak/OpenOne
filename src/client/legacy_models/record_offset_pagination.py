...
class LRecordOffsetPagination(object):
    ...
    attribute_map = {
        ...
        'pageoffsetparam': 'pageoffsetparam',
    ...
    def __init__(self, pagination_type=None, pageoffsetparam=None, pagesizeparam=None, pagesize=None):  # noqa: E501
        ...
        self.pageoffsetparam = pageoffsetparam
        self.pagesizeparam = pagesizeparam
    ...
    def pageoffsetparam(self, pageoffsetparam):
        ...
        if pageoffsetparam is None:
            raise ValueError("Invalid value for `pageoffsetparam`, must not be `None`")  # noqa: E501

        self._pageoffsetparam = pageoffsetparam
    ...
    def pagesizeparam(self, pagesizeparam):
        ...
        if pagesizeparam is None:
            raise ValueError("Invalid value for `pagesizeparam`, must not be `None`")  # noqa: E501

        self._pagesizeparam = pagesizeparam
    ...
    def pagesize(self, pagesize):
        ...
        """
        if pagesize is None:
            raise ValueError("Invalid value for `pagesize`, must not be `None`")  # noqa: E501
