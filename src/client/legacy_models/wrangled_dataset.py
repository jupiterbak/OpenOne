...
import six
from client.legacy_models.base_object_schema import BaseObjectSchema  # noqa: F401,E501

class LWrangledDataset(BaseObjectSchema):
    ...
    if hasattr(BaseObjectSchema, "swagger_types"):
        swagger_types.update(BaseObjectSchema.swagger_types)
    ...
    if hasattr(BaseObjectSchema, "attribute_map"):
        attribute_map.update(BaseObjectSchema.attribute_map)
    ...
    def __init__(self, flow=None, recipe=None, active_sample=None, associated_people=None, referenceinfo=None, wrangled=None, *args, **kwargs):  # noqa: E501
        """WrangledDataset - a model defined in Swagger"""  # noqa: E501
        self._flow = None
        self._recipe = None
        ...
        BaseObjectSchema.__init__(self, *args, **kwargs)

    @property
    def flow(self):
        """Gets the flow of this WrangledDataset.  # noqa: E501


        :return: The flow of this WrangledDataset.  # noqa: E501
        :rtype: object
        """
        return self._flow
    ...
    @flow.setter
    def flow(self, flow):
        """Sets the flow of this WrangledDataset.


        :param flow: The flow of this WrangledDataset.  # noqa: E501
        :type: object
        """
        if flow is None:
    ...
    @property
    def recipe(self):
        """Gets the recipe of this WrangledDataset.  # noqa: E501


        :return: The recipe of this WrangledDataset.  # noqa: E501
        :rtype: object
        """
        return self._recipe
    ...
    def recipe(self, recipe):
        """Sets the recipe of this WrangledDataset.


        :param recipe: The recipe of this WrangledDataset.  # noqa: E501
        :type: object
        """
    ...
    def active_sample(self):
        """Gets the active_sample of this WrangledDataset.  # noqa: E501


        :return: The active_sample of this WrangledDataset.  # noqa: E501
        :rtype: object
        """
    ...
    def active_sample(self, active_sample):
        """Sets the active_sample of this WrangledDataset.


        :param active_sample: The active_sample of this WrangledDataset.  # noqa: E501
        :type: object
        """
    ...
    def associated_people(self):
        """Gets the associated_people of this WrangledDataset.  # noqa: E501


        :return: The associated_people of this WrangledDataset.  # noqa: E501
        :rtype: object
        """
    ...
    def associated_people(self, associated_people):
        """Sets the associated_people of this WrangledDataset.


        :param associated_people: The associated_people of this WrangledDataset.  # noqa: E501
        :type: object
        """
    ...
    def referenceinfo(self):
        """Gets the referenceinfo of this WrangledDataset.  # noqa: E501


        :return: The referenceinfo of this WrangledDataset.  # noqa: E501
        :rtype: object
        """
    ...
    def referenceinfo(self, referenceinfo):
        """Sets the referenceinfo of this WrangledDataset.


        :param referenceinfo: The referenceinfo of this WrangledDataset.  # noqa: E501
        :type: object
        """
    ...
    @property
    def wrangled(self):
        """Gets the wrangled of this WrangledDataset.  # noqa: E501
        ...
        :return: The wrangled of this WrangledDataset.  # noqa: E501
        :rtype: bool
        """
    ...
    def wrangled(self, wrangled):
        """Sets the wrangled of this WrangledDataset.

        If false, this is an input dataset (i.e. an imported dataset or a reference dataset). If true, this flowNode contains a recipe that can be edited by the user.  # noqa: E501

        :param wrangled: The wrangled of this WrangledDataset.  # noqa: E501
        :type: bool
        """
        if wrangled is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WrangledDataset, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WrangledDataset):
            return False
