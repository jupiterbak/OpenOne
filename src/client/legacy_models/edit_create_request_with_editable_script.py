...
class LEditCreateRequestWithEditableScript(object):
    ...
    swagger_types = {
        'parent_id': 'int',
        'scriptlines': 'list[object]',
        'editablescript_id': 'int'
    }

    attribute_map = {
        'parent_id': 'parentId',
        'scriptlines': 'scriptlines',
        'editablescript_id': 'editablescriptId'
    }
    ...
    def __init__(self, parent_id=None, scriptlines=None, editablescript_id=None):  # noqa: E501
        ...
        self.editablescript_id = editablescript_id
    ...
    def editablescript_id(self, editablescript_id):
        ...
        if editablescript_id is None:
            raise ValueError("Invalid value for `editablescript_id`, must not be `None`")  # noqa: E501

        self._editablescript_id = editablescript_id
