...
class LDataQualityRuleResult(object):
    ...
    def status(self, status):
        ...
        allowed_values = ["pass", "fail", "invalid"]  # noqa: E501
    ...
    def pass_count(self, pass_count):
        ...
        if pass_count is None:
            raise ValueError("Invalid value for `pass_count`, must not be `None`")  # noqa: E501
