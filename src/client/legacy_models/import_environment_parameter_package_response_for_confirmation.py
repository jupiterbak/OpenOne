...
class LImportEnvironmentParameterPackageResponseForConfirmation(object):
    ...
    attribute_map = {
        'environment_parameters_package': 'environmentParametersPackage'
    }
    ...
    def environment_parameters_package(self, environment_parameters_package):
        ...
        self._environment_parameters_package = environment_parameters_package
