...
class LInviteUsersToAccountWorkspaceRequest(object):
    ...
    swagger_types = {
        'emails': 'list[str]',
        'skip_inviter_email': 'bool'
    }

    attribute_map = {
        'emails': 'emails',
        'skip_inviter_email': 'skipInviterEmail'
    }
    ...
    def __init__(self, emails=None, skip_inviter_email=None):  # noqa: E501
        ...
        self.emails = emails
        if skip_inviter_email is not None:
            self.skip_inviter_email = skip_inviter_email
    ...
    def skip_inviter_email(self, skip_inviter_email):
        ...
        self._skip_inviter_email = skip_inviter_email
