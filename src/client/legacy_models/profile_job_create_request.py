...
import six
from client.legacy_models.base_job_create_request import BaseJobCreateRequest  # noqa: F401,E501

class LProfileJobCreateRequest(BaseJobCreateRequest):
    ...
    swagger_types = {
        ...
        'cp_job_id': 'str',
        'emrcluster': 'object',
        'emr_config_id': 'object'
    }
    if hasattr(BaseJobCreateRequest, "swagger_types"):
        swagger_types.update(BaseJobCreateRequest.swagger_types)
    ...
    if hasattr(BaseJobCreateRequest, "attribute_map"):
        attribute_map.update(BaseJobCreateRequest.attribute_map)

    def __init__(self, spec=None, execution_language=None, cp_job_id=None, emrcluster=None, emr_config_id=None, *args, **kwargs):  # noqa: E501
        """ProfileJobCreateRequest - a model defined in Swagger"""  # noqa: E501
        self._spec = None
        ...
        if cp_job_id is not None:
            self.cp_job_id = cp_job_id
        if emrcluster is not None:
            self.emrcluster = emrcluster
        if emr_config_id is not None:
            self.emr_config_id = emr_config_id
        BaseJobCreateRequest.__init__(self, *args, **kwargs)

    @property
    def spec(self):
        """Gets the spec of this ProfileJobCreateRequest.  # noqa: E501


        :return: The spec of this ProfileJobCreateRequest.  # noqa: E501
        :rtype: str
        """
        return self._spec
    ...
    @spec.setter
    def spec(self, spec):
        """Sets the spec of this ProfileJobCreateRequest.


        :param spec: The spec of this ProfileJobCreateRequest.  # noqa: E501
        :type: str
        """
        if spec is None:
    ...
    def execution_language(self):
        """Gets the execution_language of this ProfileJobCreateRequest.  # noqa: E501


        :return: The execution_language of this ProfileJobCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def execution_language(self, execution_language):
        """Sets the execution_language of this ProfileJobCreateRequest.


        :param execution_language: The execution_language of this ProfileJobCreateRequest.  # noqa: E501
        :type: str
        """
        if execution_language is None:
            raise ValueError("Invalid value for `execution_language`, must not be `None`")  # noqa: E501
        allowed_values = ["spark", "emrSpark", "databricksSpark"]  # noqa: E501
        if execution_language not in allowed_values:
            raise ValueError(
                "Invalid value for `execution_language` ({0}), must be one of {1}"  # noqa: E501
                .format(execution_language, allowed_values)
            )

        self._execution_language = execution_language

    @property
    def cp_job_id(self):
        """Gets the cp_job_id of this ProfileJobCreateRequest.  # noqa: E501


        :return: The cp_job_id of this ProfileJobCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cp_job_id(self, cp_job_id):
        """Sets the cp_job_id of this ProfileJobCreateRequest.


        :param cp_job_id: The cp_job_id of this ProfileJobCreateRequest.  # noqa: E501
        :type: str
        """

        self._cp_job_id = cp_job_id

    @property
    def emrcluster(self):
        """Gets the emrcluster of this ProfileJobCreateRequest.  # noqa: E501


        :return: The emrcluster of this ProfileJobCreateRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def emrcluster(self, emrcluster):
        """Sets the emrcluster of this ProfileJobCreateRequest.


        :param emrcluster: The emrcluster of this ProfileJobCreateRequest.  # noqa: E501
        :type: object
        """
    ...
    def emr_config_id(self):
        """Gets the emr_config_id of this ProfileJobCreateRequest.  # noqa: E501


        :return: The emr_config_id of this ProfileJobCreateRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def emr_config_id(self, emr_config_id):
        """Sets the emr_config_id of this ProfileJobCreateRequest.


        :param emr_config_id: The emr_config_id of this ProfileJobCreateRequest.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProfileJobCreateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProfileJobCreateRequest):
            return False
