...
class LImportedDatasetPayload(object):
    ...
    """
    swagger_types = {
        'imported_dataset': 'object',
        'inferred_script': 'object',
        'flow': 'object',
        'name': 'str'
    }
    ...
    attribute_map = {
        ...
        'inferred_script': 'inferredScript',
        'flow': 'flow',
        'name': 'name'
    }
    ...
    def __init__(self, imported_dataset=None, inferred_script=None, flow=None, name=None):  # noqa: E501
        ...
        if inferred_script is not None:
            self.inferred_script = inferred_script
        self.flow = flow
        self.name = name
    ...
    def inferred_script(self, inferred_script):
        ...
        self._inferred_script = inferred_script
