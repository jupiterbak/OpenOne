...
class LIncludeDeleted41(object):
    ...
    def __init__(self):  # noqa: E501
        """IncludeDeleted41 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IncludeDeleted41, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IncludeDeleted41):
            return False
