...
class LReplaceDatasetResponse(object):
    ...
    attribute_map = {
        ...
        'output_node_edges': 'outputNodeEdges'
    }
    ...
    def __init__(self, new_input_node=None, output_node_edges=None):  # noqa: E501
        ...
        self.new_input_node = new_input_node
        self.output_node_edges = output_node_edges
    ...
    def new_input_node(self, new_input_node):
        ...
        if new_input_node is None:
            raise ValueError("Invalid value for `new_input_node`, must not be `None`")  # noqa: E501

        self._new_input_node = new_input_node
    ...
    def output_node_edges(self, output_node_edges):
        ...
        self._output_node_edges = output_node_edges
