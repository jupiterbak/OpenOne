...
class LOptions(object):
    ...
    """
    swagger_types = {
        'enable_auto_insights': 'bool',
        'enable_app_builder': 'bool',
        'enable_cloud_exec': 'bool',
        'enable_emr_serverless': 'bool',
        'enable_ai_din': 'bool',
        'enable_designer_cloud': 'bool',
        'enable_auto_ml': 'bool',
        'cloud_exec_max_scaling': 'int'
    }
    ...
    def __init__(self, enable_auto_insights=None, enable_app_builder=None, enable_cloud_exec=None, enable_emr_serverless=None, enable_ai_din=None, enable_designer_cloud=None, enable_auto_ml=None, cloud_exec_max_scaling=None):  # noqa: E501
        ...
        self._enable_emr_serverless = None
        self._enable_ai_din = None
        self._enable_designer_cloud = None
        self._enable_auto_ml = None
        self._cloud_exec_max_scaling = None
        self.discriminator = None
        if enable_auto_insights is not None:
            self.enable_auto_insights = enable_auto_insights
        if enable_app_builder is not None:
            self.enable_app_builder = enable_app_builder
        if enable_cloud_exec is not None:
            self.enable_cloud_exec = enable_cloud_exec
        if enable_emr_serverless is not None:
            self.enable_emr_serverless = enable_emr_serverless
        if enable_ai_din is not None:
            self.enable_ai_din = enable_ai_din
        if enable_designer_cloud is not None:
            self.enable_designer_cloud = enable_designer_cloud
        if enable_auto_ml is not None:
            self.enable_auto_ml = enable_auto_ml
        if cloud_exec_max_scaling is not None:
            self.cloud_exec_max_scaling = cloud_exec_max_scaling
    ...
    def enable_auto_insights(self, enable_auto_insights):
        ...
        self._enable_auto_insights = enable_auto_insights
    ...
    def enable_app_builder(self, enable_app_builder):
        ...
        self._enable_app_builder = enable_app_builder
    ...
    def enable_cloud_exec(self, enable_cloud_exec):
        ...
        self._enable_cloud_exec = enable_cloud_exec
    ...
    def enable_emr_serverless(self, enable_emr_serverless):
        ...
        self._enable_emr_serverless = enable_emr_serverless
    ...
    def enable_ai_din(self, enable_ai_din):
        ...
        self._enable_ai_din = enable_ai_din
    ...
    def enable_designer_cloud(self, enable_designer_cloud):
        ...
        self._enable_designer_cloud = enable_designer_cloud
    ...
    def enable_auto_ml(self, enable_auto_ml):
        ...
        self._enable_auto_ml = enable_auto_ml
    ...
    def cloud_exec_max_scaling(self, cloud_exec_max_scaling):
        ...
        self._cloud_exec_max_scaling = cloud_exec_max_scaling
