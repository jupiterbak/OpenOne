...
class LTokenAuth(object):
    ...
    swagger_types = {
        'ta_client_id': 'str',
        'ta_client_secret': 'str',
        'ta_token_id': 'str',
        'ta_token_secret': 'str'
    }

    attribute_map = {
        'ta_client_id': 'taClientId',
        'ta_client_secret': 'taClientSecret',
        'ta_token_id': 'taTokenId',
        'ta_token_secret': 'taTokenSecret'
    }
    ...
    def __init__(self, ta_client_id=None, ta_client_secret=None, ta_token_id=None, ta_token_secret=None):  # noqa: E501
        ...
        self._ta_token_secret = None
        self.discriminator = None
        self.ta_client_id = ta_client_id
        self.ta_client_secret = ta_client_secret
        self.ta_token_id = ta_token_id
        self.ta_token_secret = ta_token_secret
    ...
    def ta_client_id(self, ta_client_id):
        ...
        if ta_client_id is None:
            raise ValueError("Invalid value for `ta_client_id`, must not be `None`")  # noqa: E501

        self._ta_client_id = ta_client_id
    ...
    def ta_client_secret(self, ta_client_secret):
        ...
        if ta_client_secret is None:
            raise ValueError("Invalid value for `ta_client_secret`, must not be `None`")  # noqa: E501

        self._ta_client_secret = ta_client_secret
    ...
    def ta_token_id(self, ta_token_id):
        ...
        if ta_token_id is None:
            raise ValueError("Invalid value for `ta_token_id`, must not be `None`")  # noqa: E501

        self._ta_token_id = ta_token_id
    ...
    def ta_token_secret(self, ta_token_secret):
        ...
        if ta_token_secret is None:
            raise ValueError("Invalid value for `ta_token_secret`, must not be `None`")  # noqa: E501

        self._ta_token_secret = ta_token_secret
