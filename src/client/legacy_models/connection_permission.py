...
class LConnectionPermission(object):
    ...
    def __init__(self, role=None, person=None, connection=None, created_at=None, updated_at=None):  # noqa: E501
        """ConnectionPermission - a model defined in Swagger"""  # noqa: E501
        self._role = None
        self._person = None
    ...
    @property
    def role(self):
        """Gets the role of this ConnectionPermission.  # noqa: E501


        :return: The role of this ConnectionPermission.  # noqa: E501
        :rtype: str
        """
        return self._role
    ...
    @role.setter
    def role(self, role):
        """Sets the role of this ConnectionPermission.


        :param role: The role of this ConnectionPermission.  # noqa: E501
        :type: str
        """
        if role is None:
            raise ValueError("Invalid value for `role`, must not be `None`")  # noqa: E501
        allowed_values = ["owner", "readOnly"]  # noqa: E501
    ...
    @property
    def person(self):
        """Gets the person of this ConnectionPermission.  # noqa: E501


        :return: The person of this ConnectionPermission.  # noqa: E501
        :rtype: object
        """
        return self._person
    ...
    def person(self, person):
        """Sets the person of this ConnectionPermission.


        :param person: The person of this ConnectionPermission.  # noqa: E501
        :type: object
        """
        if person is None:
    ...
    @property
    def connection(self):
        """Gets the connection of this ConnectionPermission.  # noqa: E501


        :return: The connection of this ConnectionPermission.  # noqa: E501
        :rtype: object
        """
    ...
    def connection(self, connection):
        """Sets the connection of this ConnectionPermission.


        :param connection: The connection of this ConnectionPermission.  # noqa: E501
        :type: object
        """
    ...
    @property
    def created_at(self):
        """Gets the created_at of this ConnectionPermission.  # noqa: E501

        The time this object was first created.  # noqa: E501

        :return: The created_at of this ConnectionPermission.  # noqa: E501
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this ConnectionPermission.

        The time this object was first created.  # noqa: E501

        :param created_at: The created_at of this ConnectionPermission.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def updated_at(self):
        """Gets the updated_at of this ConnectionPermission.  # noqa: E501

        The time this object was last updated.  # noqa: E501

        :return: The updated_at of this ConnectionPermission.  # noqa: E501
        :rtype: datetime
        """
    ...
    def updated_at(self, updated_at):
        """Sets the updated_at of this ConnectionPermission.

        The time this object was last updated.  # noqa: E501

        :param updated_at: The updated_at of this ConnectionPermission.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConnectionPermission, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConnectionPermission):
            return False
