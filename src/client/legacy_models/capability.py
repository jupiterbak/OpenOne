...
class LCapability(object):
    ...
    def capability_id(self, capability_id):
        ...
        if capability_id is None:
            raise ValueError("Invalid value for `capability_id`, must not be `None`")  # noqa: E501
    ...
    def capability_group(self, capability_group):
        ...
        self._capability_group = capability_group
    ...
    def product_code(self, product_code):
        ...
        allowed_values = ["PLATFORM", "PLANS", "APP_BUILDER", "AUTO_INSIGHTS", "CLOUD_EXECUTION_FOR_DESKTOP", "DESIGNER_CLOUD", "DESIGNER_CLOUD_POWERED_BY_TRIFACTA", "DESIGNER_DESKTOP", "LOCATION_INTELLIGENCE", "MACHINE_LEARNING", "SERVER"]  # noqa: E501
        if product_code not in allowed_values:
            raise ValueError(
                "Invalid value for `product_code` ({0}), must be one of {1}"  # noqa: E501
                .format(product_code, allowed_values)
            )
