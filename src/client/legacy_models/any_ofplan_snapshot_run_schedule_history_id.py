...
class LAnyOfplanSnapshotRunScheduleHistoryId(object):
    ...
    def __init__(self):  # noqa: E501
        """AnyOfplanSnapshotRunScheduleHistoryId - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AnyOfplanSnapshotRunScheduleHistoryId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnyOfplanSnapshotRunScheduleHistoryId):
            return False
