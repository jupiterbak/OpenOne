...
class LAnyOfawsRoleCreateRequestPersonId(object):
    ...
    def __init__(self):  # noqa: E501
        """AnyOfawsRoleCreateRequestPersonId - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AnyOfawsRoleCreateRequestPersonId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnyOfawsRoleCreateRequestPersonId):
            return False
