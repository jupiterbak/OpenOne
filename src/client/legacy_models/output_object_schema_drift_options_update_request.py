...
class LOutputObjectSchemaDriftOptionsUpdateRequest(object):
    ...
    swagger_types = {
        ...
        'stop_job_on_errors_found': 'str'
    }

    attribute_map = {
        'schema_validation': 'schemaValidation',
        'stop_job_on_errors_found': 'stopJobOnErrorsFound'
    }
    ...
    def __init__(self, schema_validation='true', stop_job_on_errors_found='false'):  # noqa: E501
        ...
        if stop_job_on_errors_found is not None:
            self.stop_job_on_errors_found = stop_job_on_errors_found
    ...
    def stop_job_on_errors_found(self, stop_job_on_errors_found):
        ...
        self._stop_job_on_errors_found = stop_job_on_errors_found
