...
class LPlanOtherNodeCreateRequest(object):
    ...
    def task_type(self, task_type):
        ...
        allowed_values = ["ml_predict", "ml_retrain", "script_sql", "ml_project_update", "reporting_generate", "cefd_desktop", "li_project_replay", "ai_dataset", "email", "delay", "approval"]  # noqa: E501
