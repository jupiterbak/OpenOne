...
class LUpdateGroupResponse(object):
    ...
    def auto_provisioned(self, auto_provisioned):
        ...
        if auto_provisioned is None:
            raise ValueError("Invalid value for `auto_provisioned`, must not be `None`")  # noqa: E501

        self._auto_provisioned = auto_provisioned
