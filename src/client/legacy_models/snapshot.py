...
class LSnapshot(object):
    ...
    attribute_map = {
        ...
        'flow': 'flow',
        'terminal_flow_node': 'terminalFlowNode',
        'id': 'id',
    ...
    def __init__(self, terminal_index=None, flow=None, terminal_flow_node=None, id=None, created_at=None, updated_at=None, creator=None, updater=None):  # noqa: E501
        ...
        if flow is not None:
            self.flow = flow
        if terminal_flow_node is not None:
            self.terminal_flow_node = terminal_flow_node
        self.id = id
    ...
    def terminal_flow_node(self, terminal_flow_node):
        ...
        self._terminal_flow_node = terminal_flow_node
