...
import six
from client.legacy_models.base_job_response import BaseJobResponse  # noqa: F401,E501

class LWrangleJobResponse(BaseJobResponse):
    ...
    swagger_types = {
        ...
        'cp_job_id': 'str',
        'wranglescript': 'object',
        'emrcluster': 'object',
        'id': 'int'
    }
    if hasattr(BaseJobResponse, "swagger_types"):
        swagger_types.update(BaseJobResponse.swagger_types)

    attribute_map = {
        'execution_language': 'executionLanguage',
        'cp_job_id': 'cpJobId',
        'wranglescript': 'wranglescript',
        'emrcluster': 'emrcluster',
        'id': 'id'
    }
    if hasattr(BaseJobResponse, "attribute_map"):
        attribute_map.update(BaseJobResponse.attribute_map)

    def __init__(self, execution_language=None, cp_job_id=None, wranglescript=None, emrcluster=None, id=None, *args, **kwargs):  # noqa: E501
        """WrangleJobResponse - a model defined in Swagger"""  # noqa: E501
        ...
        if wranglescript is not None:
            self.wranglescript = wranglescript
        if emrcluster is not None:
            self.emrcluster = emrcluster
        self.id = id
        BaseJobResponse.__init__(self, *args, **kwargs)

    @property
    def execution_language(self):
        """Gets the execution_language of this WrangleJobResponse.  # noqa: E501
        ...
        :return: The execution_language of this WrangleJobResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def execution_language(self, execution_language):
        """Sets the execution_language of this WrangleJobResponse.

        Execution language. Indicate on which engine the job was executed.   Can be null/missing for scheduled jobs that fail during the validation phase.  * `photon` - Photon engine. High performance embedded engine designed for small datasets (up to 1GB).       Not available for all product editions. * `amp` - Amp engine. * `xml-amp` - XML-AMP engine. Only available for standard workflows.    * `emrSpark` - Spark engine running on EMR       # noqa: E501

        :param execution_language: The execution_language of this WrangleJobResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def cp_job_id(self):
        """Gets the cp_job_id of this WrangleJobResponse.  # noqa: E501


        :return: The cp_job_id of this WrangleJobResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def cp_job_id(self, cp_job_id):
        """Sets the cp_job_id of this WrangleJobResponse.


        :param cp_job_id: The cp_job_id of this WrangleJobResponse.  # noqa: E501
        :type: str
        """
    ...
    def wranglescript(self):
        """Gets the wranglescript of this WrangleJobResponse.  # noqa: E501


        :return: The wranglescript of this WrangleJobResponse.  # noqa: E501
        :rtype: object
        """
    ...
    def wranglescript(self, wranglescript):
        """Sets the wranglescript of this WrangleJobResponse.


        :param wranglescript: The wranglescript of this WrangleJobResponse.  # noqa: E501
        :type: object
        """

        self._wranglescript = wranglescript

    @property
    def emrcluster(self):
        """Gets the emrcluster of this WrangleJobResponse.  # noqa: E501


        :return: The emrcluster of this WrangleJobResponse.  # noqa: E501
        :rtype: object
        """
    ...
    def emrcluster(self, emrcluster):
        """Sets the emrcluster of this WrangleJobResponse.


        :param emrcluster: The emrcluster of this WrangleJobResponse.  # noqa: E501
        :type: object
        """
    ...
    @property
    def id(self):
        """Gets the id of this WrangleJobResponse.  # noqa: E501

        unique identifier for this object.  # noqa: E501

        :return: The id of this WrangleJobResponse.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this WrangleJobResponse.

        unique identifier for this object.  # noqa: E501

        :param id: The id of this WrangleJobResponse.  # noqa: E501
        :type: int
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WrangleJobResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WrangleJobResponse):
            return False
