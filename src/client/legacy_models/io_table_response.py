...
class LIoTableResponse(object):
    ...
    attribute_map = {
        'vendor': 'vendor',
        'database_connect_string': 'databaseConnectString',
    ...
    def __init__(self, vendor=None, database_connect_string=None, relational_path=None, table=None, action=None, query=None):  # noqa: E501
        ...
        self.vendor = vendor
        self.database_connect_string = database_connect_string
    ...
    def database_connect_string(self, database_connect_string):
        ...
        if database_connect_string is None:
            raise ValueError("Invalid value for `database_connect_string`, must not be `None`")  # noqa: E501

        self._database_connect_string = database_connect_string
    ...
    def relational_path(self, relational_path):
        ...
        if relational_path is None:
            raise ValueError("Invalid value for `relational_path`, must not be `None`")  # noqa: E501
