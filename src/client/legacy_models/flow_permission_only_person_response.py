...
import six
from client.legacy_models.person_public_info import PersonPublicInfo  # noqa: F401,E501

class LFlowPermissionOnlyPersonResponse(PersonPublicInfo):
    ...
    if hasattr(PersonPublicInfo, "swagger_types"):
        swagger_types.update(PersonPublicInfo.swagger_types)

    attribute_map = {
    }
    if hasattr(PersonPublicInfo, "attribute_map"):
        attribute_map.update(PersonPublicInfo.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """FlowPermissionOnlyPersonResponse - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        PersonPublicInfo.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FlowPermissionOnlyPersonResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FlowPermissionOnlyPersonResponse):
            return False
