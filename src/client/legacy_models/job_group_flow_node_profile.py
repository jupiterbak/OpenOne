...
class LJobGroupFlowNodeProfile(object):
    ...
    attribute_map = {
        'profiler_type_check_histograms': 'profilerTypeCheckHistograms',
        'profiler_valid_value_histograms': 'profilerValidValueHistograms',
        'profiler_rules': 'profilerRules',
    ...
    def __init__(self, profiler_type_check_histograms=None, profiler_valid_value_histograms=None, profiler_rules=None, column_types=None):  # noqa: E501
        ...
        if profiler_type_check_histograms is not None:
            self.profiler_type_check_histograms = profiler_type_check_histograms
        if profiler_valid_value_histograms is not None:
            self.profiler_valid_value_histograms = profiler_valid_value_histograms
        if profiler_rules is not None:
            self.profiler_rules = profiler_rules
