...
class LWorkloadErrorReportSchema(object):
    ...
    def job_group_id(self, job_group_id):
        ...
        if job_group_id is None:
            raise ValueError("Invalid value for `job_group_id`, must not be `None`")  # noqa: E501
    ...
    def workload_error(self, workload_error):
        ...
        self._workload_error = workload_error
