...
class LPlanSnapshotRunList(object):
    ...
    def __init__(self, data=None, count=None):  # noqa: E501
        """PlanSnapshotRunList - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._count = None
    ...
    @property
    def data(self):
        """Gets the data of this PlanSnapshotRunList.  # noqa: E501


        :return: The data of this PlanSnapshotRunList.  # noqa: E501
        :rtype: list[PlanSnapshotRun]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this PlanSnapshotRunList.


        :param data: The data of this PlanSnapshotRunList.  # noqa: E501
        :type: list[PlanSnapshotRun]
        """
        if data is None:
    ...
    @property
    def count(self):
        """Gets the count of this PlanSnapshotRunList.  # noqa: E501


        :return: The count of this PlanSnapshotRunList.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this PlanSnapshotRunList.


        :param count: The count of this PlanSnapshotRunList.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PlanSnapshotRunList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PlanSnapshotRunList):
            return False
