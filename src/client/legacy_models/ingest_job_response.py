...
class LIngestJobResponse(BaseJobResponse):
    ...
    attribute_map = {
        'location': 'location',
        'force_cache_update': 'forceCacheUpdate',
    ...
    def __init__(self, location=None, force_cache_update=None, cache_action=None, datasource=None, id=None, *args, **kwargs):  # noqa: E501
        """IngestJobResponse - a model defined in Swagger"""  # noqa: E501
        self._location = None
        ...
        if force_cache_update is not None:
    ...
    @property
    def location(self):
        """Gets the location of this IngestJobResponse.  # noqa: E501


        :return: The location of this IngestJobResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def location(self, location):
        """Sets the location of this IngestJobResponse.


        :param location: The location of this IngestJobResponse.  # noqa: E501
        :type: str
        """
    ...
    def force_cache_update(self):
        """Gets the force_cache_update of this IngestJobResponse.  # noqa: E501


        :return: The force_cache_update of this IngestJobResponse.  # noqa: E501
        :rtype: bool
        """
    ...
    def force_cache_update(self, force_cache_update):
        """Sets the force_cache_update of this IngestJobResponse.


        :param force_cache_update: The force_cache_update of this IngestJobResponse.  # noqa: E501
        :type: bool
        """

        self._force_cache_update = force_cache_update

    @property
    def cache_action(self):
        """Gets the cache_action of this IngestJobResponse.  # noqa: E501


        :return: The cache_action of this IngestJobResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def cache_action(self, cache_action):
        """Sets the cache_action of this IngestJobResponse.


        :param cache_action: The cache_action of this IngestJobResponse.  # noqa: E501
        :type: str
        """
        allowed_values = ["NOOP", "WRITE", "READ", "WRITE_FAILURE"]  # noqa: E501
        if cache_action not in allowed_values:
            raise ValueError(
                "Invalid value for `cache_action` ({0}), must be one of {1}"  # noqa: E501
                .format(cache_action, allowed_values)
            )
    ...
    @property
    def datasource(self):
        """Gets the datasource of this IngestJobResponse.  # noqa: E501


        :return: The datasource of this IngestJobResponse.  # noqa: E501
        :rtype: object
        """
    ...
    def datasource(self, datasource):
        """Sets the datasource of this IngestJobResponse.


        :param datasource: The datasource of this IngestJobResponse.  # noqa: E501
        :type: object
        """
    ...
    @property
    def id(self):
        """Gets the id of this IngestJobResponse.  # noqa: E501

        unique identifier for this object.  # noqa: E501

        :return: The id of this IngestJobResponse.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this IngestJobResponse.

        unique identifier for this object.  # noqa: E501

        :param id: The id of this IngestJobResponse.  # noqa: E501
        :type: int
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IngestJobResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IngestJobResponse):
            return False
