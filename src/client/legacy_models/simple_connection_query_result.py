...
class LSimpleConnectionQueryResult(object):
    ...
    def type(self, type):
        ...
        allowed_values = ["TABLE", "VIEW", "LEGACYSQLVIEW", "SCHEMA", "CATALOG", "EXTERNAL_UNITY_VOLUME", "MANAGED_UNITY_VOLUME"]  # noqa: E501
    ...
    def type_term(self, type_term):
        ...
        if type_term is None:
            raise ValueError("Invalid value for `type_term`, must not be `None`")  # noqa: E501

        self._type_term = type_term
