...
class LBaseJobCreateRequest(object):
    ...
    def job_type(self, job_type):
        ...
        allowed_values = ["wrangle", "profile", "publish", "filewriter", "filereader", "fileconverter", "ingest", "artifactstaging", "sqlexecution", "schemadrift"]  # noqa: E501
    ...
    def jobgroup_id(self, jobgroup_id):
        ...
        if jobgroup_id is None:
            raise ValueError("Invalid value for `jobgroup_id`, must not be `None`")  # noqa: E501
