...
class LReplaceImportedDatasetWithWrangledDataset(object):
    ...
    attribute_map = {
        'imported_dataset_id': 'importedDatasetId',
        'new_wrangled_dataset_id': 'newWrangledDatasetId'
    }
    ...
    def __init__(self, imported_dataset_id=None, new_wrangled_dataset_id=None):  # noqa: E501
        ...
        self.imported_dataset_id = imported_dataset_id
        self.new_wrangled_dataset_id = new_wrangled_dataset_id
    ...
    def imported_dataset_id(self, imported_dataset_id):
        ...
        self._imported_dataset_id = imported_dataset_id
    ...
    def new_wrangled_dataset_id(self, new_wrangled_dataset_id):
        ...
        self._new_wrangled_dataset_id = new_wrangled_dataset_id
