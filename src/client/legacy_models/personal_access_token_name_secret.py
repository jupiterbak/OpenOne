...
class LPersonalAccessTokenNameSecret(object):
    ...
    attribute_map = {
        'personal_access_token_name': 'personalAccessTokenName',
        'personal_access_token_secret': 'personalAccessTokenSecret'
    }
    ...
    def personal_access_token_name(self, personal_access_token_name):
        ...
        if personal_access_token_name is None:
            raise ValueError("Invalid value for `personal_access_token_name`, must not be `None`")  # noqa: E501
    ...
    def personal_access_token_secret(self, personal_access_token_secret):
        ...
        if personal_access_token_secret is None:
            raise ValueError("Invalid value for `personal_access_token_secret`, must not be `None`")  # noqa: E501
