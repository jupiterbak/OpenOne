...
class LOutputNodeEdges(object):
    ...
    attribute_map = {
        'id': 'id',
        'flow_id': 'flowId',
        'in_flow_node_id': 'inFlowNodeId',
        'out_flow_node_id': 'outFlowNodeId'
    }
    ...
    def __init__(self, id=None, flow_id=None, in_flow_node_id=None, out_flow_node_id=None):  # noqa: E501
        ...
        self._out_flow_node_id = None
        self.discriminator = None
        self.id = id
        self.flow_id = flow_id
        self.in_flow_node_id = in_flow_node_id
        self.out_flow_node_id = out_flow_node_id
    ...
    def in_flow_node_id(self, in_flow_node_id):
        ...
        self._in_flow_node_id = in_flow_node_id
    ...
    def out_flow_node_id(self, out_flow_node_id):
        ...
        self._out_flow_node_id = out_flow_node_id
